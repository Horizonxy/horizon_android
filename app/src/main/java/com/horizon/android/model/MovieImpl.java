...
public class MovieImpl implements MovieInterface {
    ...
    @Override
    public Subscription getMovies(String title, int pagesize, int offset, Subscriber<JuheResult<List<MovieVo>>> subscriber) {
        return ApiManager.getMovies(title, pagesize, offset)
