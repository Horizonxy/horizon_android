...

{
    ...
    public void moveToCenter() {
        ...
        int height = getHeight();
        if (width == 0 || height == 0) {
            width = Application.getInstance().SCREENWIDTH;
            height = Application.getInstance().SCREENHEIGHT;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(isHasBorder) {
            // 画边框
            RectF rec = getMatrixRectF();// canvas.getClipBounds();
            rec.bottom--;
            rec.right--;
